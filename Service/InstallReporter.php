<?php
/**
 * Standalone install + heartbeat reporter for Panth_SocialMeta.
 *
...
namespace Panth\SocialMeta\Service;
...
{
    public const MAGENTO_MODULE = 'Panth_SocialMeta';
    public const COMPOSER_PACKAGE = 'mage2kishan/module-social-meta';
